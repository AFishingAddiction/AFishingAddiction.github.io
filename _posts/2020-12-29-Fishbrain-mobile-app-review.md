...
![Community Reviews in the Fishbrain App](/images/fishbrain-app/community-reviews_Long-Lake-Channel.png "A screenshot of Community Reviews in the Fishbrain app"){:.mobile-screenshot}
...
![Review Form for a Specific Water](/images/fishbrain-app/review-form-for-Summit-Lake.png "A screenshot of the review form for Summit Lake taken from the Fishbrain app"){:.mobile-screenshot}
![Review Questions for a Specific Water](/images/fishbrain-app/review-questions-for-specific-water.png "A screenshot of the review questions for the Fishbrain app"){:.mobile-screenshot}
...
![Catch Log Details](/images/fishbrain-app/about-the-catch-top.png "A screenshot of the catch log details screen of the Fishbrain app"){:.mobile-screenshot}
![Catch Log Details](/images/fishbrain-app/about-the-catch-bottom.png "A screenshot of the bottom half of the catch log details screen of the Fishbrain app"){:.mobile-screenshot}
...
![Fish Species Recognition Results](/images/fishbrain-app/species-recognition-results.png "Fish species recognition results in the Fishbrain app"){:.mobile-screenshot}
...
![Top Baits for Specific Water (Pro membership)](/images/fishbrain-app/top-baits-for-Summit-Lake_Pro-membership.png "Top baits for Summit Lake in the Fishbrain app with Pro membership"){:.mobile-screenshot}
![Top Baits for Specific Water (Basic membership)](/images/fishbrain-app/top-baits-for-Summit-Lake_Basic-membership.png "Top baits for Summit Lake in the Fishbrain app with Basic membership"){:.mobile-screenshot}
...
![Area Weather Forecast (Top)](/images/fishbrain-app/weather-forecast-top.png "Screenshot of the top part of the area weather forecast in the Fishbrain app"){:.mobile-screenshot}
![Area Weather Forecast (Bottom)](/images/fishbrain-app/weather-forecast-bottom.png "Screenshot of the bottom part of the area weather forecast in the Fishbrain app"){:.mobile-screenshot}
...
![Interactive Map Filter](/images/fishbrain-app/interactive-map-filter.png "Screenshot of the interactive map filters in the Fishbrain app"){:.mobile-screenshot}
...
![Feed Preferences](/images/fishbrain-app/feed-preferences.png "Fishbrain app feed preferences"){:.mobile-screenshot}

Your feed also suggests other accounts to follow, based on your preferences and current anglers you follow.

![Suggested Anglers and Brands](/images/fishbrain-app/suggested-anglers-and-brands.png "Suggested anglers and brands in the Fishbrain app feed"){:.mobile-screenshot}
...
![Recent Catches for Summit Lake](/images/fishbrain-app/recent-catches-for-Summit-Lake.png "Photos of recent catches for Summit Lake in the Fishbrain app"){:.mobile-screenshot}
...
![Exact catch positions for Summit Lake](/images/fishbrain-app/exact-catch-positions-for-Summit-Lake.png "Screenshot of Summit Lake in the Fishbrain app with exact catch positions feature enabled"){:.mobile-screenshot}
...
![Full List of Top Baits for Specific Water (Pro membership)](/images/fishbrain-app/top-baits-for-Summit-Lake_Pro-membership_full.png "Full List of Top baits for Summit Lake in the Fishbrain app with Pro membership"){:.mobile-screenshot}
...
![BiteTime&trade; for Map Area (Pro membership)](/images/fishbrain-app/BiteTime(TM)-for-Summit-Lake-area_Pro-membership.png "Screenshot of BiteTime for Summit Lake area in the Fishbrain app with Pro membership"){:.mobile-screenshot}
![BiteTime&trade; for Map Area (Basic membership)](/images/fishbrain-app/BiteTime(TM)-for-Summit-Lake-area_Basic-membership.png "Screenshot of BiteTime for Summit Lake area in the Fishbrain app with Basic membership"){:.mobile-screenshot}
...
![Depth Contours for Summit Lake](/images/fishbrain-app/depth-contours-for-Summit-Lake.png "Map of Summit Lake with the depth contours feature enabled in the Fishbrain app"){:.mobile-screenshot}
...
![Dropping a Private Waypoint](/images/fishbrain-app/dropping-a-waypoint.png "Dropping a private waypoint in Summit Lake in the Fishbrain app"){:.mobile-screenshot}
![Editing a Private Waypoint](/images/fishbrain-app/edit-waypoint.png "Screenshot of the edit waypoint screen in the Fishbrain app"){:.mobile-screenshot}
![List of Waypoint Symbols/Icons](/images/fishbrain-app/waypoint-symbol-list.png "List of available icons for a private waypoint in the Fishbrain app"){:.mobile-screenshot}
...
![Create a Group](/images/fishbrain-app/create-group.png "Screenshot of the create group screen in the Fishbrain app"){:.mobile-screenshot}
...
![Spot Prediction](/images/fishbrain-app/spot-prediction.png "Screenshot Summit Lake with the Spot Prediction feature enabled in the Fishbrain app"){:.mobile-screenshot}
...
![Add Gear](/images/fishbrain-app/add-gear.png "Screenshot of the add gear screen in the Fishbrain app"){:.mobile-screenshot}
...
![Gear Ratings and Reviews](/images/fishbrain-app/gear-ratings-and-reviews.png "Gear ratings and reviews in the Fishbrain app"){:.mobile-screenshot}
...
![In-app Fishbrain Shop](/images/fishbrain-app/in-app-shop.png "Screenshot of categories of baits and lures in the in-app Fishbrain shop"){:.mobile-screenshot}
